...
set :user, 'allhailskippyvps'  # Your dreamhost account's username
set :domain, 'youtube_tonight.thatsps.com'  # Dreamhost servername where your account is located 
set :tmp_dir, '/home/allhailskippyvps/tmp'

# Default branch is :master
# ask :branch, proc { `git rev-parse --abbrev-ref HEAD`.chomp }.call

# Default deploy_to directory is /var/www/my_app_name
set :deploy_to, "/home/allhailskippyvps/youtubetonight"  # The standard Dreamhost setup
